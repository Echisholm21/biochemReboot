...
%Load stage2_Q
load B_stage2_Q_BIO
%edited test 2.8 to have a salinity difference threshold of 0.08 rather
%than 0.2, and edited test 2.9 to include SLCA with a gradient threshold
%identical to NITR and PHOS
% July 2019, E. Chisholm (BIO) emily.chisholm@dfo-mpo.gc.ca
...
%------------------------------------------------------------------
%edited to include SLCA at BIO (July 2019 - E. Chisholm
case 29
 K=[];  
 Tn=B_nan_doubtful(T);
